      ...
      <section id="profil" className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Profil Klinik & SDM</h2>
            <div className="w-24 h-1 bg-sky-500 mx-auto rounded"></div>
            <p className="mt-4 max-w-2xl mx-auto text-gray-600">Representasi vital infrastruktur kesehatan primer yang melayani populasi dinamis di pinggiran utara Yogyakarta.</p>
          </div>
          ...
          <h3 className="text-2xl font-bold text-center text-gray-900 mb-10">Struktur Tenaga Kesehatan Inti</h3>
